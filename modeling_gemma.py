...
class GemmaRMSNorm(nn.Module): # Normalization
...
class GemmaRotaryEmbedding(nn.Module): # Positional Encoding
...
class GemmaMLP(nn.Module): # Feed Forward Network
...
class GemmaDecoderLayer(nn.Module): # Transformer Layer
...
class GemmaForCausalLM(nn.Module): # Language Model Head
